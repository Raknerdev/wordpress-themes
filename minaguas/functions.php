...
function newsup_setup() {
	...
	// custom header Support
			...
			'right-image'		=>  get_template_directory_uri() .'/images/right-footer.png',
			'left-image'		=>  get_template_directory_uri() .'/images/left-footer.png',
			...
			'tubhelca'		=>  get_template_directory_uri() .'/images/entes/tubhelca.png',
			...
			'hidroandes'		=>  get_template_directory_uri() .'/images/entes/hidroandes.png',
			...
			'inasa'		=>  get_template_directory_uri() .'/images/entes/inasa.png',
